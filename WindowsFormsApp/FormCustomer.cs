...
namespace WindowsFormsApp
{
    ...
    {
        CustomerDTO khachHang;
        public FormCustomer(CustomerDTO khachHang)
        {
            InitializeComponent();
        ...
        {
            if (CustomerBUS.Intance.suaKH(khachHang.MaKH, txtHoTen.Text, txtDiaChi.Text, txtSDT.Text, txtEmail.Text, khachHang.MaHang))
            {
        ...
        {
            dataGridView1.DataSource = BillBUS.Intance.LoadDanhSachDonHangTheoKH(MaKH);
        ...
        {
            FormChangePassword frm = new FormChangePassword(khachHang.MatKhau, true, khachHang.MaKH);
            frm.ShowDialog();
        }
    }
}
