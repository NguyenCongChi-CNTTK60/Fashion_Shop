...
namespace WindowsFormsApp
{
    public partial class UC_PhieuNhap : UserControl
    {
        ...
        void loadData()
        {
            dgvPhieuNhap.DataSource = PhieuNhapBUS.Intance.GetListCoupon();
        ...
        private void btnXoaPhieu_Click(object sender, EventArgs e)
        {
            ...
            if (dlr == DialogResult.Yes)
            {
                ...
                if (PhieuNhapBUS.Intance.deleteCoupon(dgvPhieuNhap.Rows[VT].Cells[0].Value.ToString().Trim()))
                {
        ...
        private void btnXuatExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                row1_NguoiTao.Value2 = FormDangNhap.tenNgDung;
                ...
                System.Data.DataTable data = ChiTietPNBUS.Intance.getCouponInfo(maPNChon);
        ...
        {
            dgvPhieuNhap.DataSource = PhieuNhapBUS.Intance.searchCoupon(txtTimKiem.Text);
        }
